...
setDynamicScriptSettings() {
    ...
    mkdir -p ${DSIP_SYSTEM_CONFIG_DIR}{,/gui,/kamailio} ${SRC_DIR} ${DSIP_RUN_DIR} ${DSIP_CERTS_DIR} ${BACKUPS_DIR}
...
function updateKamailioConfig {
    ...
    setKamailioConfigDef 'FLT_CARRIER' "$FLT_CARRIER" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_PBX' "$FLT_PBX" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_MSTEAMS' "$FLT_MSTEAMS" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_INTERNAL' "$FLT_INTERNAL" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_OUTBOUND' "$FLT_OUTBOUND" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_INBOUND' "$FLT_INBOUND" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_LCR_MIN' "$FLT_LCR_MIN" ${DSIP_CONFIG_FILE}
    setKamailioConfigDef 'FLT_FWD_MIN' "$FLT_FWD_MIN" ${DSIP_CONFIG_FILE}
